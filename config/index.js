...
export const config = {
  ...
  dayTrade: {
    ...
    fallbackMinConfidence: parseFloat_('DAY_TRADE_FALLBACK_MIN_CONFIDENCE', 0.3),
    takeProfitPct: parseFloat_('DAY_TRADE_TAKE_PROFIT_PCT', 0.012),
    stopLossPct: parseFloat_('DAY_TRADE_STOP_LOSS_PCT', 0.006),
    trendProximityPct: parseFloat_('DAY_TRADE_TREND_PROXIMITY_PCT', 0.012),
    rsiMin: parseFloat_('DAY_TRADE_RSI_MIN', 36),
    rsiMax: parseFloat_('DAY_TRADE_RSI_MAX', 72),
    maxTradesPerSession: parseInt_('DAY_TRADE_MAX_TRADES_PER_SESSION', 12),
    maxOpenPositions: parseInt_('DAY_TRADE_MAX_OPEN_POSITIONS', 3),
  ...
  smallAccount: {
    ...
    maxOpenPositions: parseInt_('SMALL_ACCOUNT_MAX_OPEN_POSITIONS', 3),
