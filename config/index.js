...
export const config = {
  ...
  dayTrade: {
    ...
    minConfidence: parseFloat_('DAY_TRADE_MIN_CONFIDENCE', 0.35),
    fallbackMinConfidence: parseFloat_('DAY_TRADE_FALLBACK_MIN_CONFIDENCE', 0.28),
    ...
    maxThresholdRelaxation: parseFloat_('DAY_TRADE_MAX_THRESHOLD_RELAXATION', 0.14),
  },
